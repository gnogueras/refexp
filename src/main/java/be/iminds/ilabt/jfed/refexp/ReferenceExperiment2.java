 ...
 * @author gerard
 */
public class ReferenceExperiment2 {
    
    // scp Reference Experiment
    public static void main(String[] args) throws Exception {
        ...
        System.out.println("\n-----------------------------\nSCP EXPERIMENT\n-----------------------------");
        String fileSliver1 = CreateFileInSliver.run(config.getSshPrivateKeyFilename(), sliversInfo.get(0).getLoginHostname(), sliversInfo.get(0).getLoginUsername(), 1);
        //String fileSliver2 = CreateFileInSliver.run(config.getSshPrivateKeyFilename(), sliversInfo.get(1).getLoginHostname(), sliversInfo.get(1).getLoginUsername(), 2);
        SCP.fromRemoteHost(config.getSshPrivateKeyFilename(), dir.getPath()+File.separator+fileSliver1,
                sliversInfo.get(0).getLoginUsername(), sliversInfo.get(0).getLoginHostname(), fileSliver1);
        SCP.toRemoteHost(config.getSshPrivateKeyFilename(), dir.getPath()+File.separator+fileSliver1,
                sliversInfo.get(1).getLoginUsername(), sliversInfo.get(1).getLoginHostname(), fileSliver1);
